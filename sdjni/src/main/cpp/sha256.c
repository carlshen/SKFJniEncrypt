...
{
    sc->totalLength = 0LL;
    sc->hash[0] = 0xc1059ed8UL;
    sc->hash[1] = 0x367cd507UL;
    sc->hash[2] = 0x3070dd17UL;
    sc->hash[3] = 0xf70e5939UL;
    sc->hash[4] = 0xffc00b31UL;
    sc->hash[5] = 0x68581511UL;
    sc->hash[6] = 0x64f98fa7UL;
    sc->hash[7] = 0xbefa4fa4UL;
    sc->bufferLength = 0L;
}
...
void
SHA256Final (SHA256Context *sc, uint8_t hash[SHA256_HASH_SIZE], int words)
{
  uint32_t bytesToPad;
  uint64_t lengthPad;
  int i;
